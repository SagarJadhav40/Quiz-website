...
<title>CodeGeniusQuest || FEEDBACK </title>
...
<div class="col-lg-6">
<span class="logo">CodeGeniusQuest</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:CodeGeniusQuest@gmail.com" style="color:#000000">CodeGeniusQuest@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.png" width=100 height=100 alt="CodeGeniusQuest" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Sagar || Akhilesh || Laxmikant</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7406747743</h4>
		<h4 style="font-family:'typo' ">CodeGeniusQuest@gmail.com</h4>
		<h4 style="font-family:'typo' ">PDA college of engineering,klb.</h4></div></div>
		</p>
      </div>
